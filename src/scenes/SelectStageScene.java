...
public class SelectStageScene extends Scene{
	
	public SelectStageScene(GamePanel parent) {
    	this.parent = parent;
		...
		while (Mouse.next()) {
			...
			if (Mouse.getEventButtonState()) {
				...
				if (Mouse.getEventButton() == StaticContent.LEFT_BUTTON) {
					parent.currentScene = new DraftScene(parent);
				}
	...
	public void renderInterface() {
        ...
        RenderGL.drawRectWithTexture(TextureManager.selectStage, 0, 0, width, height, 1);
